...
expName = 'testFTtutorial'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='G:\\Dyski współdzielone\\CortiVision\\Hardware\\PRODUKCJA\\2022\\Pendrive contents\\Sample Experiments\\2021 Tutorial PsychoPy Finger Tapping using LSL\\testFTtutorial_lastrun.py',
...
# Setup the Window
win = visual.Window(
    size=[1000, 500], fullscr=False, screen=0, 
...
startComponents = [text_3, key_resp_2]
...
for thisTrial in trials:
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if text.status == STARTED:
            ...
            if tThisFlipGlobal > text.tStartRefresh + 12-frameTolerance:
